...
--
-- 表的结构 `mantis_bugnote_text_table`
--
...
--
-- 表的结构 `mantis_bug_relationship_table`
--
...
--
-- 表的结构 `mantis_bug_revision_table`
--
...
--
-- 表的结构 `mantis_custom_field_project_table`
--
...
--
-- 表的结构 `mantis_custom_field_string_table`
--
...
--
-- 表的结构 `mantis_custom_field_table`
--
...
--
-- 转存表中的数据 `mantis_email_table`
--

INSERT INTO `mantis_email_table` (`email_id`, `email`, `subject`, `metadata`, `body`, `submitted`) VALUES
(6, 'root@localhost', '[MantisBT] 问题管理系统帐号注册', 'a:4:{s:7:"headers";a:0:{}s:8:"priority";i:3;s:7:"charset";s:5:"utf-8";s:8:"hostname";s:9:"localhost";}', '已创建如下账号：\n\n用户名: 1\n电子邮箱: wen1750686723@qq.com\nIP 地址: 127.0.0.1\nhttp://localhost/mantisbt/\n\n此邮件由系统自动生成，请勿回复', 1431942669),
(4, 'root@localhost', '[MantisBT] 问题管理系统帐号注册', 'a:4:{s:7:"headers";a:0:{}s:8:"priority";i:3;s:7:"charset";s:5:"utf-8";s:8:"hostname";s:9:"localhost";}', '已创建如下账号：\n\n用户名: wenbo123\n电子邮箱: wen1750686723@qq.com\nIP 地址: 127.0.0.1\nhttp://localhost/mantisbt/\n\n此邮件由系统自动生成，请勿回复', 1431942560);

-- --------------------------------------------------------

--
-- 表的结构 `mantis_filters_table`
--
...
--
-- 表的结构 `mantis_project_file_table`
--
...
--
-- 表的结构 `mantis_project_hierarchy_table`
--
...
--
-- 表的结构 `mantis_project_user_list_table`
--
...
--
-- 表的结构 `mantis_project_version_table`
--
...
--
-- 转存表中的数据 `mantis_tokens_table`
--

INSERT INTO `mantis_tokens_table` (`id`, `owner`, `type`, `value`, `timestamp`, `expiry`) VALUES
(2, 3, 4, '1', 1431942779, 1431943079),
(3, 1, 4, '1', 1431942810, 1431943238);

-- --------------------------------------------------------

--
-- 表的结构 `mantis_user_pref_table`
--
...
--
-- 表的结构 `mantis_user_print_pref_table`
--
...
--
-- 表的结构 `mantis_user_profile_table`
--
...
(1, 'administrator', '', 'root@localhost', '63a9f0ea7bb98050796b649e85481845', 1, 0, 90, 7, 0, 0, '403f01d27bfff841a23b8cd8f246a46414e174554f6a2178fef537bdadf99410', 1431942938, 1431941158),
(2, 'wenbo', 'wenbo', 'wen1750686723@qq.com', '37223f43d244bfd008cb7742e19ac7bf', 1, 0, 70, 0, 0, 0, '79191167fa0ed416c56bf504bfbe2649dfe10667c9cae4fe747d4c7a2e08f042', 1431941545, 1431941545),
(3, 'wenbo123', 'weo', 'wen1750686723@qq.com', 'afa5775c07f15f24ae6763caec4c3426', 1, 0, 55, 1, 0, 0, 'a00a151b915c558759f521fa259bb488a58dfe1e0e71be3de262e6b58f226c12', 1431942796, 1431942555),
(4, '1', '', 'wen1750686723@qq.com', 'b76298e91c5445fbdd909d0613af794f', 1, 0, 25, 0, 0, 0, 'ab79bce40f8851e7b047c57270d73175cb5749efb4399a7d689f6c9fe6a8402a', 1431942661, 1431942661);
